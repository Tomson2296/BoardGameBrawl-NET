...
namespace BoardGameBrawl.Persistence.Migrations
{
    ...
    [Migration("20241229204458_Add_Player_Table")]
    partial class Add_Player_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardGameBrawl.Domain.Entities.Match", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BoardGameBrawl.Domain.Entities.Player", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BoardGameBrawl.Domain.Entities.Tournament", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BoardGameBrawl.Domain.Entities.TournamentMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BoardGameBrawl.Domain.Entities.GroupParticipants", b =>
                {
                    ...
                    b.HasOne("BoardGameBrawl.Domain.Entities.Player", "Player")
                        .WithMany("GroupParticipants")
            ...
            modelBuilder.Entity("BoardGameBrawl.Domain.Entities.TournamentMatch", b =>
                {
                    ...
                    b.HasOne("BoardGameBrawl.Domain.Entities.Tournament", null)
                        .WithMany("TournamentMatches")
